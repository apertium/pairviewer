    ...
    for repo_name in types:
        ...
        for type_content in types_data:
            ...
            if "apertium" in lang_name_pair and (lang_name_pair.count("-") == 2):
                ...
                # We parse out the initial commit from a header in this shape: '<https://api.github.com/repositories/124326860/commits?client_id=f55561171db254c8481c&client_secret=59fa2eb87e77f2f841cc4fba06fb6185121d1b5e&page=2>; rel="next", <https://api.github.com/repositories/124326860/commits?client_id=f55561171db254c8481c&client_secret=59fa2eb87e77f2f841cc4fba06fb6185121d1b5e&page=21>; rel="last"'
